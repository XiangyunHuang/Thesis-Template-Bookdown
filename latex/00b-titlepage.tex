...
\begin{flushleft}
\hspace{0.5cm}\makebox[0.16\textwidth][s]{\zihao{4}\songti 中图分类号}：\underline{\makebox[0.2\textwidth][c]{O212.4}}
\hspace{2.8cm}\makebox[0.13\textwidth][s]{\zihao{4}\songti 单位代码}：\underline{\makebox[0.2\textwidth][c]{11413}}
\vspace{0.2cm}\\
\hspace{0.5cm}\makebox[0.16\textwidth][s]{\zihao{4}\songti 密级}：\underline{\makebox[0.2\textwidth][c]{公开}}
\end{flushleft}
