...
\begin{equation}
f_{Y}(y;\theta,\phi) = \exp\{ \big(y\theta - b(\theta) \big)/a(\phi) + c(y,\phi) \}
...
f_{Y}(y;\theta,\phi) & = \frac{1}{\sqrt{2\pi\sigma^2}} \exp\{-\frac{(y - \mu)^2}{2\sigma^2}  \}  \\
 & = \exp \{ (y\mu - \mu^2/2)/\sigma^2 - \frac{1}{2}\big(y^2/\sigma^2 + \log(2\pi\sigma^2)\big)\}
...
\begin{equation}
\mathsf{E}\big( \frac{\partial^2 l}{\partial \theta^2} \big) + \mathsf{E}(\frac{\partial l}{\partial \theta})^2  = 0
(\#eq:variance-log-lik)
\end{equation}
