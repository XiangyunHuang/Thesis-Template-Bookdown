...
在贝叶斯方法框架下，
Peter J. Diggle 等（1998年）使用随机游走的 Metropolis 算法实现马尔科夫链蒙特卡罗获得模型参数的后验密度分布及后验量的估计值，

Håvard Rue 等（2009 年） 将空间随机效应假定为马尔科夫随机场，提出集成嵌套拉普拉斯算法，。

在基于似然的框架下，

2004 年 Ole F Christensen 实现的蒙特卡罗最大似然估计， 
